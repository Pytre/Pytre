/* Infos requête
Code : ZIMMOBFC
Description : Etat export flux pour BFC
*/

DECLARE
@1 as date = '2021-10-01',	-- Date Début|0|fiscal_year(9, -12, 1)
@2 as date = '2021-12-31',	-- Date Fin|0|month_end(-1)
@3 as nchar(5) = ' ',	-- Société (facultatif)|1
@4 as nchar(7) = ' ',	-- Cpte immos début (facultatif)|1
@5 as nchar(7) = ' ',	-- Cpte immos fin (facultatif)|1
@6 as nvarchar(10) = 'FRA'	-- Plan de compte|0
;
